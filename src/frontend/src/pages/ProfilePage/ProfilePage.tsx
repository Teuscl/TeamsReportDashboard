...
import { updateMyProfile } from "@/services/userService"; // Seu serviço para atualizar o usuário
...
const ProfilePage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await updateMyProfile(updatePayload); // Ajuste updateUser para aceitar o payload correto
